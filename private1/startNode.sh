...
geth console --datadir ./private1 --networkid 15 --mine --etherbase=0 --rpc --rpcapi "admin,personal,eth,web3" --port 30301 --rpcaddr 192.168.1.10 --rpcport 8541 --nodiscover --unlock 0,1,2 --password ./passwdfile